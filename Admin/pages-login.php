...
<head>
  ...
  <title>Pages / Login - Courier Management System</title>
          ...
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form method="post" action="<?php echo $_SERVER["PHP_SELF"];?>" class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      <p class="small mb-0"><?php echo $loginError;?><a href="#">Forget Password</a></p>
              ...
              <div class="credits">
                ...
                Designed by <a href="#">Students of Aptech Learning</a>
              </div>
            </div>
          </div>
        </div>
